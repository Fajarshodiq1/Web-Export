    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div
            ...
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-white font-medium mb-7">Page</h4>
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href="javascript:;" class="text-white font-semibold">Home</a></li>
                    <li class="mb-6"><a href="javascript:;" class=" text-white font-semibold">About Us</a></li>
                    <li class="mb-6"><a href="javascript:;" class=" text-white font-semibold">Products</a></li>
                    <li class="mb-6"><a href="javascript:;" class=" text-white font-semibold">Contact</a></li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left ">
                <h4 class="text-lg text-white font-medium mb-7">Get in touch</h4>
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6 text-white">almeakausaeterna@gmail.com</li>
                    <li class="mb-6 text-white">+62 851 9000 0236</li>
                    <li class="mb-6 text-white">Indonesia</li>
                </ul>
            </div>
            <!--End Col-->
            <div class="lg:mx-auto text-left ">
