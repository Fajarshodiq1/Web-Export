  <div class="max-w-[1280px] w-full mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-4 gap-3">
      ...
      <div class="relative h-[80vh] seccond">
          <img src="{{ asset('assets/money.jpg') }}" alt="Image 2"
      ...
      <div class="relative h-[80vh] third">
          <img src="{{ asset('assets/image.DNG') }}" alt="Image 3"
              class="object-cover w-full h-full grayscale rounded-xl">
          <div
              class="absolute inset-0 flex items-start justify-center text-center text-white bg-black bg-opacity-50 rounded-xl">
              <div class="mt-20">
                  <h2 class="text-3xl md:text-4xl font-bold mb-2 text-green-500">Order <br> Preparation</h2>
