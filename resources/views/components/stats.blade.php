<section class="h-[80vh] md:h-[60vh] relative flex items-center justify-center" id="stats-section">
        ...
        <div class="text-white w-full">
            <div class="container px-5 mx-auto flex flex-col md:flex-row items-center justify-center">
                <header class="flex flex-col text-center w-1/2 mb-20 items-center justify-center mt-14">
                    <h1 class="text-2xl md:text-3xl lg:text-6xl font-extrabold drop-shadow-2xl">
                        Our Global <br>
                        Achievements in <br> Numbers
                    </h1>
                </header>
                <main class="flex -m-4 text-center gap-4 md:w-1/2">
                    <article class="p-4 w-full flex flex-col items-center justify-center">
                        <figure class="px-4 py-6 rounded-lg">
                            ...
                            <figcaption>
                                <h2 class="font-bold text-xl md:text-2xl lg:text-4xl text-white my-3" id="counter1">0
                                </h2>
                                <p class="leading-relaxed tracking-widest text-sm md:text-xl">
                    ...
                    <article class="p-4 w-full flex flex-col items-center justify-center">
                        <figure class="px-4 py-6 rounded-lg">
                            ...
                            <figcaption>
                                <h2 class="font-bold text-xl md:text-2xl lg:text-4xl text-white my-3" id="counter2">0
                                </h2>
                                <p class="leading-relaxed tracking-widest text-sm md:text-xl">
